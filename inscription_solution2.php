...
// Préparation des variables de la requête
$variables = array(
              'pseudo' => $_POST["pseudo"],
...
$requete = " INSERT INTO utilisateurs(pseudo, mot_de_passe) VALUES(:pseudo, :mot_passe) ";
            
// Envoie de cette requete à la base en préparation
$envoie = $base -> prepare($requete);

// Envoie des variables pour l'exécution
