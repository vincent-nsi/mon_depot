...
$variables = array($_POST["pseudo"], sha1($_POST["mot_passe"]));
...
<html>
    ...
    <h1>Bienvenue sur le serveur.</h1>
      ...
      if ($donnees = $reponse -> fetch()){
			print("vous êtes bien identifé ".$donnees['pseudo']."<br>");
			// Enregistrement de l'identification
      		$_SESSION['valide'] = "ok";
		}   		
	  else {
	  		print("Désolé ! Mais vous ne figurez pas dans la base de données.<br>");
	  		// Enregistrement de l'echec
	  		$_SESSION['valide'] = "pas_ok";
	  }	  
	  print("<a href='page_protegee.php'>page protégée</a>.");
